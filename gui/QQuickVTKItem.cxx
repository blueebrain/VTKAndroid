...
#if ANDROID
    vtkAndroidInteractorAdapter qt2vtkInteractorAdapter;
#else
...
QSGNode* QQuickVTKItem::updatePaintNode(QSGNode* node, UpdatePaintNodeData*)
{
    ...
    if(d->qt2vtkInteractorAdapter.GetDevicePixelRatio()!=n->m_devicePixelRatio)
    d->qt2vtkInteractorAdapter.SetDevicePixelRatio(n->m_devicePixelRatio,n->vtkWindow->GetInteractor());
