#include "vtkandroidinteractorstyle.h"
...
VTK_ABI_NAMESPACE_BEGIN
    vtkStandardNewMacro(vtkAndroidInteractorStyle);


vtkAndroidInteractorStyle::vtkAndroidInteractorStyle()
{
...
void vtkAndroidInteractorStyle::OnMouseMove()
{
...
void vtkAndroidInteractorStyle::OnLeftButtonDown()
{
    int x = this->Interactor->GetEventPosition()[0];
    int y = this->Interactor->GetEventPosition()[1];
...
void vtkAndroidInteractorStyle::OnLeftButtonUp()
{
    switch (this->State)
    {
    case VTKIS_PAN:
...
void vtkAndroidInteractorStyle::OnMiddleButtonDown()
{
    this->OnLeftButtonUp();//Since the double-click operation triggers leftbutton click first, cancel the click
    int x = this->Interactor->GetEventPosition()[0];
    int y = this->Interactor->GetEventPosition()[1];
...
void vtkAndroidInteractorStyle::OnRightButtonDown()
{
    this->OnLeftButtonUp();//Since the double-click operation triggers single click first, cancel the click
    int x = this->Interactor->GetEventPosition()[0];
    int y = this->Interactor->GetEventPosition()[1];
...
void vtkAndroidInteractorStyle::Rotate()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
...
void vtkAndroidInteractorStyle::Spin()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
...
void vtkAndroidInteractorStyle::Pan()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
...
void vtkAndroidInteractorStyle::Dolly()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
...
void vtkAndroidInteractorStyle::UniformScale()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
    ...
    double yf = this->Interactor->GetScale() / this->Interactor->GetLastScale();
    double scaleFactor = yf;
...
void vtkAndroidInteractorStyle::PrintSelf(ostream& os, vtkIndent indent)
{
    this->Superclass::PrintSelf(os, indent);
}


void vtkAndroidInteractorStyle::FindPickedActor(int x, int y)
{
...
void vtkAndroidInteractorStyle::Prop3DTransform(
